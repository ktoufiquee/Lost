...
void iShowImage(double x, double y, double width, double height, unsigned int texture)
{
...
void iShowImage(double x, double y, double modifier, unsigned int texture)
{
